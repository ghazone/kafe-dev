<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center">
                    <a href="{{ route('admin.dashboard') }}">
                        ...
                        <img src="{{ asset('storage/m240.png') }}" class="w-9 h-9" alt="Image">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.transaction.index')" :active="request()->routeIs('pesanan')">
                        {{ __('Pesanan') }}
                    </x-nav-link>
                </div>
            ...
            <div class="modal fade" id="userNotAdminModal" tabindex="-1" role="dialog"
                aria-labelledby="userNotAdminModalLabel" aria-hidden="true">
